<template>
  <header
    ...
    <!-- Home Link -->
    <NuxtLink to="/"
      class="flex w-8 h-8 rounded-full border border-ash items-center justify-center text-hsa hover:bg-ash/20 hover:text-BtW transition-all duration-200 shadow-sm"
