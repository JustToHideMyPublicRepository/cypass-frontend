<template>
  <aside :class="[
    ...
    <!-- Footer Action -->
    <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-ash bg-ash/10 space-y-4">
...
import { IconLayoutDashboard as IconDashboard, IconCalendar, IconLogout, IconChevronLeft, IconChevronRight } from '@tabler/icons-vue'
