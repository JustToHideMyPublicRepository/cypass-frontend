<template>
  <aside :class="[
    'fixed inset-y-0 left-0 z-50 bg-WtB border-r border-ash transform transition-all duration-300 ease-in-out md:translate-x-0 md:static shrink-0 flex flex-col h-[100dvh] md:h-screen overflow-hidden md:overflow-visible',
