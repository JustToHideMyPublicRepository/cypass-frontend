                ...
                <div class="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                  ...
                  <div class="flex gap-1.5 ml-auto shrink-0">
                    <a v-for="(social, sIdx) in member.socials" :key="social.name" :href="social.url" target="_blank"
                      ...
                      class="p-2 bg-ashAct hover:bg-ash text-textClr hover:text-primary rounded-xl backdrop-blur-md transition-all duration-300 border border-ash/5 hover:scale-110 flex items-center justify-center"
