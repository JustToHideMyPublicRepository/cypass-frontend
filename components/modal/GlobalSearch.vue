              ...
              <div v-else class="animate-fade-in space-y-6">
                ...
                <div v-if="searchStore.recentQueries.length > 0" class="space-y-3">
                  <div class="flex items-center justify-between px-2">
                    ...
                    <button v-if="searchStore.recentSearches.length === 0"
                      @click.stop="searchStore.clearRecentSearches()"
                  ...
                  <div class="flex flex-wrap gap-2 px-2">
                    <div v-for="query in searchStore.recentQueries" :key="query"
                      ...
                      @click="searchQuery = query; handleInput()">
...
import { IconSearch, IconCornerDownLeft, IconExternalLink, IconKeyboard, IconSquareF1, IconClock, IconX, IconHistory } from '@tabler/icons-vue'
