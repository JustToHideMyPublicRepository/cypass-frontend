      ...
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="relative animate-fade-left">
          ...
          <UiAppFrame type="card" :glass="true"
            ...
            <div
              class="aspect-square flex flex-col items-center justify-center p-8 relative overflow-hidden bg-slate-900/40">
              ...
              <div
                class="relative z-10 bg-slate-900/80 backdrop-blur-md p-6 rounded-2xl border border-slate-700/50 text-center shadow-2xl max-w-xs group-hover:border-primary/50 transition-colors">
                <h3 class="text-xl font-bold text-white mb-2">Gardien du Numérique</h3>
