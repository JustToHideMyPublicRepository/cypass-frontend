      ...
      <div class="flex flex-wrap justify-center items-center gap-10 md:gap-16">
        <template v-for="partner in partners" :key="partner.name">
          <a :href="partner.website" target="_blank"
            class="h-10 md:h-12 w-auto flex items-center justify-center grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300 hover:scale-110">
