      ...
      <div v-for="(service, index) in featureServices" :key="service.id"
        ...
        <div class="relative" :class="index % 2 === 1 ? 'lg:order-2' : 'lg:order-1'">
          ...
          <div
            ...
            <div v-if="service.id === 'docsentry'" class="p-4 min-h-[400px] flex items-center justify-center">
            ...
            <div v-if="service.status !== 'available'"
              ...
              <span class="px-6 py-3 bg-slate-900 text-white rounded-full font-bold shadow-xl">Bientôt Disponible</span>
            </div>
          </div>
        </div>
      </div>
