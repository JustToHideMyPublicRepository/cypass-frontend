...
export const getHistoryStatusInfo = (status: string = 'default') => {
  return HISTORY_STATUS_CONFIG[status as keyof typeof HISTORY_STATUS_CONFIG] || HISTORY_STATUS_CONFIG['default']
}
