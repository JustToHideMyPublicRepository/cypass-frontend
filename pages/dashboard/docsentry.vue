    ...
    <BaseCard>
      <div class="flex flex-col md:flex-row gap-4">
        <div class="flex-1 relative">
           ...
           <input type="text" placeholder="Rechercher par nom ou hash..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 focus:ring-2 focus:ring-cypass-blue focus:border-transparent text-sm" />
        </div>
        <div class="flex gap-2">
           <select class="px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-sm focus:ring-2 focus:ring-cypass-blue">
    ...
    <BaseCard class="overflow-hidden p-0">
       <div class="overflow-x-auto">
         <table class="w-full text-sm text-left">
            <thead class="text-xs text-slate-500 uppercase bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700">
               <tr>
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
               <tr v-for="doc in cypassData.documents" :key="doc.id" class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                  <td class="px-6 py-4">
                     <div class="flex items-center gap-3">
                        <div class="p-2 rounded bg-blue-50 dark:bg-blue-900/20 text-cypass-blue dark:text-blue-400">
                  ...
                  <td class="px-6 py-4 text-right">
                     <button class="text-slate-400 hover:text-cypass-blue transition-colors mx-1">
       ...
       <div class="px-6 py-4 border-t border-slate-200 dark:border-slate-700 flex items-center justify-between">
          <div class="text-sm text-slate-500">Affichage de <span class="font-medium">1</span> à <span class="font-medium">3</span> sur <span class="font-medium">3</span> résultats</div>
          <div class="flex gap-2">
