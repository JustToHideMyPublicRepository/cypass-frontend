      ...
      <div class="grid lg:grid-cols-4 gap-12">
        ...
        <div class="hidden lg:block lg:col-span-1">
          <div class="sticky top-32 space-y-4">
            <h3 class="font-bold mb-4 px-4">Sommaire</h3>
            <nav class="flex flex-col space-y-1">
              <a v-for="item in toc" :key="item.id" :href="`#${item.id}`"
                class="px-4 py-2 text-sm rounded-lg transition-colors text-hsa hover:text-primary hover:bg-ash">
                {{ item.label }}
              </a>
            </nav>
          </div>
        ...
        <div class="lg:col-span-3 space-y-8 animate-fade-up" style="animation-delay: 100ms">
          ...
          <section id="editor" class="glass-panel p-8 md:p-10 rounded-3xl border border-ash/50">
            <h2 class="text-2xl font-bold mb-6 flex items-center gap-3">
              <span
                class="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary text-lg">1</span>
              Éditeur du Service
            </h2>
            <div class="prose prose-slate max-w-none">
              ...
              <div class="grid md:grid-cols-2 gap-6 not-prose mt-6">
                <div class="p-4 rounded-2xl bg-ash/50 border border-ash">
                  <h4 class="font-bold mb-2">Siège Social</h4>
          ...
          <section id="hosting" class="glass-panel p-8 md:p-10 rounded-3xl border border-ash/50">
            <h2 class="text-2xl font-bold mb-6 flex items-center gap-3">
              <span
                class="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary text-lg">2</span>
              Hébergement
            </h2>
            <div class="prose prose-slate max-w-none">
              <p>
              ...
              <ul class="not-prose space-y-2 mt-4">
                <li class="flex items-center gap-3 text-sm text-hsa">
          ...
          <section id="ip" class="glass-panel p-8 md:p-10 rounded-3xl border border-ash/50">
            <h2 class="text-2xl font-bold mb-6 flex items-center gap-3">
              <span
                class="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary text-lg">3</span>
...
import { IconServer, IconCertificate } from '@tabler/icons-vue'
...
const toc = [
  { id: 'editor', label: '1. Éditeur du Service' },
